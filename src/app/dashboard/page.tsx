                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {[
                      ...
                      <div key={s.title} className="bg-white dark:bg-zinc-800 rounded-2xl p-6 border border-zinc-200 dark:border-zinc-700 hover:shadow-md transition-shadow group flex flex-col">
                        ...
                        <button onClick={() => handleRoleChange('patient')} className="mt-auto text-sm font-bold text-purple-600 dark:text-purple-400 flex items-center gap-1 hover:gap-2 transition-all w-fit">
